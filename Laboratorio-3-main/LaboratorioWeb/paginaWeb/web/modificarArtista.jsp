...
<html>
    ...
    <body>
        ...
        <form id="form" action="modificarArtista" class="d-flex flex-column align-items-center">
            <h1><b>Modificar Artista</b></h1>
            <div class="row">
                ...
                <div class="col-6 d-flex justify-content-start">
                    <div class="mt-4 d-flex flex-column text-center">
                        ...
                        <input name="fecha" id="date" type="date" class="input-group-text"/>
                    </div>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <div class="mt-4 d-flex flex-column text-center">
                        <label><b>Apellido</b></label>
                        <input name="apellido" id="apellido" class="input-group-text"/>
                    </div>
                </div>
                <div class="col-6 d-flex justify-content-start">
                    <div class="mt-4 d-flex flex-column text-center">
                        <label><b>Descripcion</b></label>
                        <input name="descripcion" id="descripcion" class="input-group-text"/>
                    </div>
                </div>
                <div class="col-6 d-flex justify-content-end">
                    <div class="mt-4 d-flex flex-column text-center">
                        <label><b>Biografia</b></label>
                        <input name="biografia" id="biografia" class="input-group-text"/>
                    </div>
                </div>
                <div class="col-6 d-flex justify-content-start">
                    <div class="mt-4 d-flex flex-column text-center">
                        <label><b>Sitio web</b></label>
                        <input name="sitioweb" id="sitioweb" class="input-group-text"/>
                    </div>
                </div>
                ...
                <div class="mt-3 col-12 d-flex justify-content-center">
                    <div class="col-3 d-flex justify-content-between">
                        <a href=""> <button id="cancelar" type="button" style="background-color: #94778B;" class="btn">Cancelar</button> </a>
                        <button name="aceptar" id="aceptar" type="submit" style="background-color: #82D4BB;" class="btn">Aceptar</button>
                    </div>
                </div>
            </div>
            <jsp:include page = "agente.jsp" />
