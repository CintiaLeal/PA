...
<html>
    ...
    <body>
        ...
        <div class="row d-flex flex-column align-items-center">
            <h1 id="titulo">Listo!</h1>
        </div>
        <div class="row d-flex flex-column align-items-center">
            <h2>Su petición ha sido procesada con éxito</h2>
        </div>
        <form action="exito" id="form">
            <div class="row d-flex flex-column align-items-center">
                <button id="btn" type="submit" class="button button1"><b>Volver al inicio</b></button>
            </div>
        </form>
    </body>
</html>
