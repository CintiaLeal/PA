...
public class Alta_Funcion_Espectaculo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        espectaculos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                espectaculosActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(artistasinvitados, 0, 261, Short.MAX_VALUE)
                    .addComponent(name)
                    .addComponent(horainicio)
                    .addComponent(fechaF, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
                    .addComponent(aceptarfuncion, javax.swing.GroupLayout.Alignment.TRAILING))
    ...
    private void aceptarplatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarplatActionPerformed
        ...
        List<String> list = sis.listarEspectaculoPl(cbPlataforma5.getSelectedItem().toString());
        for(int i = 0; i < list.size(); i++){
            String enombre = list.get(i);
            espectaculos.addItem(enombre);
    ...
    private void aceptarfuncionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarfuncionActionPerformed
        ...
        String fechaAlta = d.toString();
        
        String fecha = simpleDateFormat.format(fechaAlta);
        ...
        if((name.getText().length() != 0) && (horainicio.getText().length() != 0) && (fecha != "")){
            if(!sis.existeFuncion(name.getText())){
                ...
                sis.altaFuncion(plataforma, espectaculo,resultado1, name.getText(), fecha, horainicio.getText(),"");
    ...
    private void espectaculosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_espectaculosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_espectaculosActionPerformed
