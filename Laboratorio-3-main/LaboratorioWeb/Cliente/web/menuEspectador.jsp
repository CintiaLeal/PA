        ...
        <div class="row d-flex flex-column align-items-center">
            ...
            <form action="menuEspectador" method="post" id="form">
               ...
               <button id="consultarUsuario" name="consultarUsuario" class="btn my-3 button "><b>Consultar Usuario</b></button>
                ...
                <button id="favorito" name="favorito" class="btn my-3 button"><b>Marcar/Desmarcar espectaculos favoritos</b></button>
                <button id="valorar" name="valorar" class="btn my-3 button"><b>Valorar espectaculo</b></button>
            </form>
        </div>
    </body>
