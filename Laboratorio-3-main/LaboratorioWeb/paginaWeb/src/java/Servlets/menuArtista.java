    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion != null) {
            ...
            if (u == 2) {
                ...
                if (envio.equals("1")) {
                    List<String> listaPac = sis.listarPaquetes();
...
//                    List<String> listaPla = listaPlataforma.getLista();
                ...
                if(envio.equals("10")){
                    List<String> listaEspectaculosAceptados = sis.listarEspectaculosArtista(user);
                ...
                if(envio.equals("11")){
                    List<String> listaE = sis.listarEspectaculosFinalizadosArtista(user);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewServlet1 at " + envio + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
            }
