        ...
        <div class="row m-0 d-flex justify-content-center">
            ...
            <div class="col-11 row my-2">
                ...
                <div class="col-5 d-flex justify-content-center"> 
                    ...
                    <div class="col-5 d-flex justify-content-center"> 
                        <label>Puntaje promedio: ${puntajeP}</label>
                        <label id="mipuntaje">${puntajeU}</label>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    if(document.getElementById("valorbtn").value = "Ya ha sido valorado"){
        document.getElementById("puntaje").className = "d-none";
    }
