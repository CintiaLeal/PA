        ...
        if (sesion != null) {
            ...
            if (u == 1) {
                ...
                if (envio.equals("1")) {
                    ...
                    ListString listaEspectaculo = sis.listarEspectaculo(plataforma);
                ...
                if (envio.equals("2")) {
                    ...
                    ListString listaEspectaculo = sis.listarEspectaculoCategoria(categoria);
                    List<String> listaE = listaEspectaculo.getLista();
                    request.setAttribute("listaEspectaculo", listaE);
                ...
                if (envio.equals("3")) {
                    ...
                    DtFunciones fun = sis.buscarFunciones(funcion);
                ...
                if (envio.equals("0")) {
                   ...
                   ListString listaCategoria = sis.listarCategorias();
                    ...
                    ListString listaRegistro = sis.listarRegistros(espectador);
