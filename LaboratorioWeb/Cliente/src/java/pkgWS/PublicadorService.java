 ...
 * 
 */
@WebServiceClient(name = "PublicadorService", targetNamespace = "http://complejoservidor/", wsdlLocation = "http://localhost:8085/publicador?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PUBLICADORSERVICE_QNAME = new QName("http://complejoservidor/", "PublicadorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8085/publicador?wsdl");
    ...
    public Publicador getPublicadorPort() {
        return super.getPort(new QName("http://complejoservidor/", "PublicadorPort"), Publicador.class);
    }
    ...
    public Publicador getPublicadorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://complejoservidor/", "PublicadorPort"), Publicador.class, features);
    }
