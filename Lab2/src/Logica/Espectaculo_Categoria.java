...
import Logica.Espectaculo_Categoria_Id;
...
public class Espectaculo_Categoria{
    ...
    @ManyToOne
    @JoinColumn(name = "e_nombre", referencedColumnName = "espectaculo_nombre", insertable = false, updatable = false)
