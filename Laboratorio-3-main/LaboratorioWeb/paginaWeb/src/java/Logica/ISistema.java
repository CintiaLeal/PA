...
public abstract class ISistema {
    ...
    public abstract void crearPDF(String nick, String premio) throws FileNotFoundException, DocumentException;
    ...
    public abstract void guardarAgente(String url, String ip, String sistemaOperativo, String navegador);
    
    public abstract List<String> listarInforme();
}
