        ...
        <div class="row d-flex flex-column align-items-center">
            ...
            <form action="menuArtista" method="post" id="formulario">
               ...
               <button id="modificarArtista" name="modificarArtista"  class="btn my-3 button"><b>Modificar Datos</b></button></a>
                ...
                <button id="consultarEspectaculoFinalizado" name="consultarEspectaculoFinalizado" class="btn my-3 button"><b>Consultar espectaculo finalizado</b></button>
            </form>
        </div>
    </body>
    ...
    <script type="text/javascript">
      ...
      consultaEspectaculo.addEventListener("click", e => {
       ...
       crearFuncion.addEventListener("click", e => {
        ...
        let consultarEspectaculoFinalizado = document.getElementById("consultarEspectaculoFinalizado");
        consultarEspectaculoFinalizado.addEventListener("click", e =>{
                e.preventDefault();
                envio.value = "11";
                formulario.submit();
        });
